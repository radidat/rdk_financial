...
<input type = 'hidden' name='signature_rdk'  id='signature-rdk' value='' >

  <div class="wrapper">
    <canvas id="signature-pad" class="signature-pad" width=250 height=150></canvas>
  </div>
  <button class='clear-signature-rdk btn btn-danger mt-4'>recommercer</button>
</div>

<button type='button' id='save-signature' class='btn btn-info col-md-12 mt-4 w-75'> enregister la signature</button>    
</div>

     <div class='col-md-7' class='wrapper-montant-ajouter-fichier' >
<div class=' montant' >
   <label for="exampleFormControlInput1" class="form-label" required>Montant</label>
   <input type="number" name='montant_de_la_location' class="form-control ">
 </div>
 ...
 <div class='file' >
   ...
   <div class='wrapper-btn-location'>
